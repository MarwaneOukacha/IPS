 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Id" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}Max34Text"/&gt;
 *         &lt;element name="SchmeNm" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}AccountSchemeName1Choice" minOccurs="0"/&gt;
...
public class GenericAccountIdentification1 {
	...
	public String toString() {
		return "GenericAccountIdentification1 {'id':'" + id + "', 'schmeNm':'" + schmeNm + "', 'issr':'" + issr + "'}";
	}
