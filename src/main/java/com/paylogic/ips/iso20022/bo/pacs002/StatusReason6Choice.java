...
/**
 * <p>Classe Java pour StatusReason6Choice complex type.
 * 
 ...
 *       &lt;choice&gt;
 *         &lt;element name="Cd" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}ExternalStatusReason1Code"/&gt;
...
public class StatusReason6Choice {
	...
	public String toString() {
		return "StatusReason6Choice {'cd':'" + cd + "', 'prtry':'" + prtry + "'}";
	}
