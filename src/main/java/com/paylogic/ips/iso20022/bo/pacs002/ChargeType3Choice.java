 ...
 *       &lt;choice&gt;
 *         &lt;element name="Cd" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}ExternalChargeType1Code"/&gt;
 *         &lt;element name="Prtry" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}GenericIdentification3"/&gt;
 *       &lt;/choice&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class ChargeType3Choice {
	...
	public String toString() {
		return "ChargeType3Choice {'cd':'" + cd + "', 'prtry':'" + prtry + "'}";
	}
