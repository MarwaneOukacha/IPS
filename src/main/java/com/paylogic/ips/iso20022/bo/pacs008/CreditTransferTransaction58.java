...
/**
 * <p>Classe Java pour CreditTransferTransaction58 complex type.
 * 
...
public class CreditTransferTransaction58 {
	...
	public String toString() {
		return "CreditTransferTransaction58 {'pmtId':'" + pmtId + "', 'pmtTpInf':'" + pmtTpInf + "', 'intrBkSttlmAmt':'"
				+ intrBkSttlmAmt + "', 'intrBkSttlmDt':'" + intrBkSttlmDt + "', 'sttlmPrty':'" + sttlmPrty
				+ "', 'sttlmTmIndctn':'" + sttlmTmIndctn + "', 'sttlmTmReq':'" + sttlmTmReq + "', 'accptncDtTm':'"
				+ accptncDtTm + "', 'poolgAdjstmntDt':'" + poolgAdjstmntDt + "', 'instdAmt':'" + instdAmt
				+ "', 'xchgRate':'" + xchgRate + "', 'chrgBr':'" + chrgBr + "', 'chrgsInf':'" + chrgsInf
				+ "', 'mndtRltdInf':'" + mndtRltdInf + "', 'prvsInstgAgt1':'" + prvsInstgAgt1
				+ "', 'prvsInstgAgt1Acct':'" + prvsInstgAgt1Acct + "', 'prvsInstgAgt2':'" + prvsInstgAgt2
				+ "', 'prvsInstgAgt2Acct':'" + prvsInstgAgt2Acct + "', 'prvsInstgAgt3':'" + prvsInstgAgt3
				+ "', 'prvsInstgAgt3Acct':'" + prvsInstgAgt3Acct + "', 'instgAgt':'" + instgAgt + "', 'instdAgt':'"
				+ instdAgt + "', 'intrmyAgt1':'" + intrmyAgt1 + "', 'intrmyAgt1Acct':'" + intrmyAgt1Acct
				+ "', 'intrmyAgt2':'" + intrmyAgt2 + "', 'intrmyAgt2Acct':'" + intrmyAgt2Acct + "', 'intrmyAgt3':'"
				+ intrmyAgt3 + "', 'intrmyAgt3Acct':'" + intrmyAgt3Acct + "', 'ultmtDbtr':'" + ultmtDbtr
				+ "', 'initgPty':'" + initgPty + "', 'dbtr':'" + dbtr + "', 'dbtrAcct':'" + dbtrAcct + "', 'dbtrAgt':'"
				+ dbtrAgt + "', 'dbtrAgtAcct':'" + dbtrAgtAcct + "', 'cdtrAgt':'" + cdtrAgt + "', 'cdtrAgtAcct':'"
				+ cdtrAgtAcct + "', 'cdtr':'" + cdtr + "', 'cdtrAcct':'" + cdtrAcct + "', 'ultmtCdtr':'" + ultmtCdtr
				+ "', 'instrForCdtrAgt':'" + instrForCdtrAgt + "', 'instrForNxtAgt':'" + instrForNxtAgt + "', 'purp':'"
				+ purp + "', 'rgltryRptg':'" + rgltryRptg + "', 'tax':'" + tax + "', 'rltdRmtInf':'" + rltdRmtInf
