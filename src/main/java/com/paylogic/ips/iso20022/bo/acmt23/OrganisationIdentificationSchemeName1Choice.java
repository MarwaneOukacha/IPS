 ...
 *       &lt;choice&gt;
 *         &lt;element name="Cd" type="{urn:iso:std:iso:20022:tech:xsd:acmt.023.001.03}ExternalOrganisationIdentification1Code"/&gt;
...
public class OrganisationIdentificationSchemeName1Choice {
	...
	public String toString() {
		return "OrganisationIdentificationSchemeName1Choice {'cd':'" + cd + "', 'prtry':'" + prtry + "'}";
	}
