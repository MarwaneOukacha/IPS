 ...
 *       &lt;choice&gt;
 *         &lt;element name="Cd" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}ExternalCashClearingSystem1Code"/&gt;
...
public class ClearingSystemIdentification3Choice {
	...
	public String toString() {
		return "ClearingSystemIdentification3Choice {'cd':'" + cd + "', 'prtry':'" + prtry + "'}";
	}
