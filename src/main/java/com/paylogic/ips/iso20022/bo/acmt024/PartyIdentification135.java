 ...
 *         &lt;element name="Id" type="{urn:iso:std:iso:20022:tech:xsd:acmt.024.001.03}Party38Choice" minOccurs="0"/&gt;
 *         &lt;element name="CtryOfRes" type="{urn:iso:std:iso:20022:tech:xsd:acmt.024.001.03}CountryCode" minOccurs="0"/&gt;
 *         &lt;element name="CtctDtls" type="{urn:iso:std:iso:20022:tech:xsd:acmt.024.001.03}Contact4" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class PartyIdentification135 {
	...
	public String toString() {
		return "PartyIdentification135 {'nm':'" + nm + "', 'pstlAdr':'" + pstlAdr + "', 'id':'" + id
				+ "', 'ctryOfRes':'" + ctryOfRes + "', 'ctctDtls':'" + ctctDtls + "'}";
	}
