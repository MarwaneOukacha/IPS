 ...
 *       &lt;sequence&gt;
 *         &lt;element name="OrgnlMsgId" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}Max35Text"/&gt;
 *         &lt;element name="OrgnlMsgNmId" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}Max35Text"/&gt;
 *         &lt;element name="OrgnlCreDtTm" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}ISODateTime" minOccurs="0"/&gt;
 *         &lt;element name="OrgnlNbOfTxs" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}Max15NumericText" minOccurs="0"/&gt;
 *         &lt;element name="OrgnlCtrlSum" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}DecimalNumber" minOccurs="0"/&gt;
 *         &lt;element name="GrpSts" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}ExternalPaymentGroupStatus1Code" minOccurs="0"/&gt;
 ...
 *         &lt;element name="NbOfTxsPerSts" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}NumberOfTransactionsPerStatus5" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class OriginalGroupHeader17 {
    ...
    /**
     * Obtient la valeur de la propriété grpSts.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Définit la valeur de la propriété grpSts.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
	...
	public String toString() {
		return "OriginalGroupHeader17 {'orgnlMsgId':'" + orgnlMsgId + "', 'orgnlMsgNmId':'" + orgnlMsgNmId
				+ "', 'orgnlCreDtTm':'" + orgnlCreDtTm + "', 'orgnlNbOfTxs':'" + orgnlNbOfTxs + "', 'orgnlCtrlSum':'"
				+ orgnlCtrlSum + "', 'grpSts':'" + grpSts + "', 'stsRsnInf':'" + stsRsnInf + "', 'nbOfTxsPerSts':'"
				+ nbOfTxsPerSts + "'}";
	}
