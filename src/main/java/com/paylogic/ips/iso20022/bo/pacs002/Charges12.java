 ...
 *         &lt;element name="Agt" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}BranchAndFinancialInstitutionIdentification6"/&gt;
 *         &lt;element name="Tp" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}ChargeType3Choice" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class Charges12 {
	...
	public String toString() {
		return "Charges12 {'amt':'" + amt + "', 'agt':'" + agt + "', 'tp':'" + tp + "'}";
	}
