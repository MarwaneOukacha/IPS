 ...
 *       &lt;sequence&gt;
 *         &lt;element name="NmPrfx" type="{urn:iso:std:iso:20022:tech:xsd:acmt.023.001.03}NamePrefix2Code" minOccurs="0"/&gt;
 *         &lt;element name="Nm" type="{urn:iso:std:iso:20022:tech:xsd:acmt.023.001.03}Max140Text" minOccurs="0"/&gt;
 *         &lt;element name="PhneNb" type="{urn:iso:std:iso:20022:tech:xsd:acmt.023.001.03}PhoneNumber" minOccurs="0"/&gt;
 *         &lt;element name="MobNb" type="{urn:iso:std:iso:20022:tech:xsd:acmt.023.001.03}PhoneNumber" minOccurs="0"/&gt;
 *         &lt;element name="FaxNb" type="{urn:iso:std:iso:20022:tech:xsd:acmt.023.001.03}PhoneNumber" minOccurs="0"/&gt;
 *         &lt;element name="EmailAdr" type="{urn:iso:std:iso:20022:tech:xsd:acmt.023.001.03}Max2048Text" minOccurs="0"/&gt;
 *         &lt;element name="EmailPurp" type="{urn:iso:std:iso:20022:tech:xsd:acmt.023.001.03}Max35Text" minOccurs="0"/&gt;
 *         &lt;element name="JobTitl" type="{urn:iso:std:iso:20022:tech:xsd:acmt.023.001.03}Max35Text" minOccurs="0"/&gt;
 *         &lt;element name="Rspnsblty" type="{urn:iso:std:iso:20022:tech:xsd:acmt.023.001.03}Max35Text" minOccurs="0"/&gt;
 *         &lt;element name="Dept" type="{urn:iso:std:iso:20022:tech:xsd:acmt.023.001.03}Max70Text" minOccurs="0"/&gt;
 *         &lt;element name="Othr" type="{urn:iso:std:iso:20022:tech:xsd:acmt.023.001.03}OtherContact1" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="PrefrdMtd" type="{urn:iso:std:iso:20022:tech:xsd:acmt.023.001.03}PreferredContactMethod1Code" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class Contact4 {
	...
	public String toString() {
		return "Contact4 {'nmPrfx':'" + nmPrfx + "', 'nm':'" + nm + "', 'phneNb':'" + phneNb + "', 'mobNb':'" + mobNb
				+ "', 'faxNb':'" + faxNb + "', 'emailAdr':'" + emailAdr + "', 'emailPurp':'" + emailPurp
				+ "', 'jobTitl':'" + jobTitl + "', 'rspnsblty':'" + rspnsblty + "', 'dept':'" + dept + "', 'othr':'"
				+ othr + "', 'prefrdMtd':'" + prefrdMtd + "'}";
	}
