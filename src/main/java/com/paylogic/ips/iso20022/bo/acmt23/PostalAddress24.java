 ...
 *       &lt;sequence&gt;
 *         &lt;element name="AdrTp" type="{urn:iso:std:iso:20022:tech:xsd:acmt.023.001.03}AddressType3Choice" minOccurs="0"/&gt;
 *         &lt;element name="Dept" type="{urn:iso:std:iso:20022:tech:xsd:acmt.023.001.03}Max70Text" minOccurs="0"/&gt;
 *         &lt;element name="SubDept" type="{urn:iso:std:iso:20022:tech:xsd:acmt.023.001.03}Max70Text" minOccurs="0"/&gt;
 *         &lt;element name="StrtNm" type="{urn:iso:std:iso:20022:tech:xsd:acmt.023.001.03}Max70Text" minOccurs="0"/&gt;
 *         &lt;element name="BldgNb" type="{urn:iso:std:iso:20022:tech:xsd:acmt.023.001.03}Max16Text" minOccurs="0"/&gt;
 *         &lt;element name="BldgNm" type="{urn:iso:std:iso:20022:tech:xsd:acmt.023.001.03}Max35Text" minOccurs="0"/&gt;
 *         &lt;element name="Flr" type="{urn:iso:std:iso:20022:tech:xsd:acmt.023.001.03}Max70Text" minOccurs="0"/&gt;
 *         &lt;element name="PstBx" type="{urn:iso:std:iso:20022:tech:xsd:acmt.023.001.03}Max16Text" minOccurs="0"/&gt;
 *         &lt;element name="Room" type="{urn:iso:std:iso:20022:tech:xsd:acmt.023.001.03}Max70Text" minOccurs="0"/&gt;
 *         &lt;element name="PstCd" type="{urn:iso:std:iso:20022:tech:xsd:acmt.023.001.03}Max16Text" minOccurs="0"/&gt;
 *         &lt;element name="TwnNm" type="{urn:iso:std:iso:20022:tech:xsd:acmt.023.001.03}Max35Text" minOccurs="0"/&gt;
 *         &lt;element name="TwnLctnNm" type="{urn:iso:std:iso:20022:tech:xsd:acmt.023.001.03}Max35Text" minOccurs="0"/&gt;
 *         &lt;element name="DstrctNm" type="{urn:iso:std:iso:20022:tech:xsd:acmt.023.001.03}Max35Text" minOccurs="0"/&gt;
 *         &lt;element name="CtrySubDvsn" type="{urn:iso:std:iso:20022:tech:xsd:acmt.023.001.03}Max35Text" minOccurs="0"/&gt;
 *         &lt;element name="Ctry" type="{urn:iso:std:iso:20022:tech:xsd:acmt.023.001.03}CountryCode" minOccurs="0"/&gt;
 *         &lt;element name="AdrLine" type="{urn:iso:std:iso:20022:tech:xsd:acmt.023.001.03}Max70Text" maxOccurs="7" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class PostalAddress24 {
	...
	public String toString() {
		return "PostalAddress24 {'adrTp':'" + adrTp + "', 'dept':'" + dept + "', 'subDept':'" + subDept
				+ "', 'strtNm':'" + strtNm + "', 'bldgNb':'" + bldgNb + "', 'bldgNm':'" + bldgNm + "', 'flr':'" + flr
				+ "', 'pstBx':'" + pstBx + "', 'room':'" + room + "', 'pstCd':'" + pstCd + "', 'twnNm':'" + twnNm
				+ "', 'twnLctnNm':'" + twnLctnNm + "', 'dstrctNm':'" + dstrctNm + "', 'ctrySubDvsn':'" + ctrySubDvsn
				+ "', 'ctry':'" + ctry + "', 'adrLine':'" + adrLine + "'}";
	}
