 ...
 *       &lt;sequence&gt;
 *         &lt;element name="DtAndPlcOfBirth" type="{urn:iso:std:iso:20022:tech:xsd:acmt.023.001.03}DateAndPlaceOfBirth1" minOccurs="0"/&gt;
 *         &lt;element name="Othr" type="{urn:iso:std:iso:20022:tech:xsd:acmt.023.001.03}GenericPersonIdentification1" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class PersonIdentification13 {
	...
	public String toString() {
		return "PersonIdentification13 {'dtAndPlcOfBirth':'" + dtAndPlcOfBirth + "', 'othr':'" + othr + "'}";
	}
