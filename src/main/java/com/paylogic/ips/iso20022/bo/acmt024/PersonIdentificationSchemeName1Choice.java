 ...
 *       &lt;choice&gt;
 *         &lt;element name="Cd" type="{urn:iso:std:iso:20022:tech:xsd:acmt.024.001.03}ExternalPersonIdentification1Code"/&gt;
...
public class PersonIdentificationSchemeName1Choice {
	...
	public String toString() {
		return "PersonIdentificationSchemeName1Choice {'cd':'" + cd + "', 'prtry':'" + prtry + "'}";
	}
