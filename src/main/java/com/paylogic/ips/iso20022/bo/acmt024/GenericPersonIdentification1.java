...
/**
 * <p>Classe Java pour GenericPersonIdentification1 complex type.
 * 
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Id" type="{urn:iso:std:iso:20022:tech:xsd:acmt.024.001.03}Max35Text"/&gt;
 *         &lt;element name="SchmeNm" type="{urn:iso:std:iso:20022:tech:xsd:acmt.024.001.03}PersonIdentificationSchemeName1Choice" minOccurs="0"/&gt;
 *         &lt;element name="Issr" type="{urn:iso:std:iso:20022:tech:xsd:acmt.024.001.03}Max35Text" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class GenericPersonIdentification1 {
	...
	public String toString() {
		return "GenericPersonIdentification1 {'id':'" + id + "', 'schmeNm':'" + schmeNm + "', 'issr':'" + issr + "'}";
	}
