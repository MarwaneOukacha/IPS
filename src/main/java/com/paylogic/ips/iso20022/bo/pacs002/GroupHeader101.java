...
/**
 * <p>Classe Java pour GroupHeader101 complex type.
 * 
 ...
 *         &lt;element name="CreDtTm" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}ISODateTime"/&gt;
 ...
 *         &lt;element name="OrgnlBizQry" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}OriginalBusinessQuery1" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class GroupHeader101 {
    ...
    /**
     * Obtient la valeur de la propriété orgnlBizQry.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Définit la valeur de la propriété orgnlBizQry.
     * 
     * @param value
     *     allowed object is
     *     {@link OriginalBusinessQuery1 }
	...
	public String toString() {
		return "GroupHeader101 {'msgId':'" + msgId + "', 'creDtTm':'" + creDtTm + "', 'instgAgt':'" + instgAgt
				+ "', 'instdAgt':'" + instdAgt + "', 'orgnlBizQry':'" + orgnlBizQry + "'}";
	}
