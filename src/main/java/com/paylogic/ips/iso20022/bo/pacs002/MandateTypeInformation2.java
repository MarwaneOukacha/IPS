 ...
 *       &lt;sequence&gt;
 *         &lt;element name="SvcLvl" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}ServiceLevel8Choice" minOccurs="0"/&gt;
 ...
 *         &lt;element name="Clssfctn" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}MandateClassification1Choice" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class MandateTypeInformation2 {
	...
	public String toString() {
		return "MandateTypeInformation2 {'svcLvl':'" + svcLvl + "', 'lclInstrm':'" + lclInstrm + "', 'ctgyPurp':'"
				+ ctgyPurp + "', 'clssfctn':'" + clssfctn + "'}";
	}
