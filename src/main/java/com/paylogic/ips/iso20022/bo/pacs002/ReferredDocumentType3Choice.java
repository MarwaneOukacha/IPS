...
/**
 * <p>Classe Java pour ReferredDocumentType3Choice complex type.
 * 
 ...
 *       &lt;choice&gt;
 *         &lt;element name="Cd" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}DocumentType6Code"/&gt;
...
public class ReferredDocumentType3Choice {
	...
	public String toString() {
		return "ReferredDocumentType3Choice {'cd':'" + cd + "', 'prtry':'" + prtry + "'}";
	}
