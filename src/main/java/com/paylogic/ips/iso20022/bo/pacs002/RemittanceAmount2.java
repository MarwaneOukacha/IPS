 ...
 *       &lt;sequence&gt;
 *         &lt;element name="DuePyblAmt" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}ActiveOrHistoricCurrencyAndAmount" minOccurs="0"/&gt;
 *         &lt;element name="DscntApldAmt" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}DiscountAmountAndType1" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="CdtNoteAmt" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}ActiveOrHistoricCurrencyAndAmount" minOccurs="0"/&gt;
 *         &lt;element name="TaxAmt" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}TaxAmountAndType1" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="AdjstmntAmtAndRsn" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}DocumentAdjustment1" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="RmtdAmt" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}ActiveOrHistoricCurrencyAndAmount" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class RemittanceAmount2 {
    ...
    /**
     * Obtient la valeur de la propriété duePyblAmt.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Définit la valeur de la propriété duePyblAmt.
     * 
     * @param value
     *     allowed object is
     *     {@link ActiveOrHistoricCurrencyAndAmount }
    ...
    /**
     * Obtient la valeur de la propriété cdtNoteAmt.
     * 
     * @return
     *     possible object is
     *     {@link ActiveOrHistoricCurrencyAndAmount }
    ...
    /**
     * Définit la valeur de la propriété cdtNoteAmt.
     * 
     * @param value
     *     allowed object is
     *     {@link ActiveOrHistoricCurrencyAndAmount }
	...
	public String toString() {
		return "RemittanceAmount2 {'duePyblAmt':'" + duePyblAmt + "', 'dscntApldAmt':'" + dscntApldAmt
				+ "', 'cdtNoteAmt':'" + cdtNoteAmt + "', 'taxAmt':'" + taxAmt + "', 'adjstmntAmtAndRsn':'"
				+ adjstmntAmtAndRsn + "', 'rmtdAmt':'" + rmtdAmt + "'}";
	}
