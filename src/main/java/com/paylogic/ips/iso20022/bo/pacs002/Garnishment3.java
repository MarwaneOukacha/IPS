 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Tp" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}GarnishmentType1"/&gt;
 *         &lt;element name="Grnshee" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}PartyIdentification135" minOccurs="0"/&gt;
 *         &lt;element name="GrnshmtAdmstr" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}PartyIdentification135" minOccurs="0"/&gt;
 ...
 *         &lt;element name="FmlyMdclInsrncInd" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}TrueFalseIndicator" minOccurs="0"/&gt;
 *         &lt;element name="MplyeeTermntnInd" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}TrueFalseIndicator" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class Garnishment3 {
	...
	public String toString() {
		return "Garnishment3 {'tp':'" + tp + "', 'grnshee':'" + grnshee + "', 'grnshmtAdmstr':'" + grnshmtAdmstr
				+ "', 'refNb':'" + refNb + "', 'dt':'" + dt + "', 'rmtdAmt':'" + rmtdAmt + "', 'fmlyMdclInsrncInd':'"
				+ fmlyMdclInsrncInd + "', 'mplyeeTermntnInd':'" + mplyeeTermntnInd + "'}";
	}
