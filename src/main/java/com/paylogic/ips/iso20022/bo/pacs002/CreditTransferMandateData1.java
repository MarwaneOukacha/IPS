 ...
 *         &lt;element name="Tp" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}MandateTypeInformation2" minOccurs="0"/&gt;
 *         &lt;element name="DtOfSgntr" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}ISODate" minOccurs="0"/&gt;
 *         &lt;element name="DtOfVrfctn" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}ISODateTime" minOccurs="0"/&gt;
 *         &lt;element name="ElctrncSgntr" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}Max10KBinary" minOccurs="0"/&gt;
 *         &lt;element name="FrstPmtDt" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}ISODate" minOccurs="0"/&gt;
 *         &lt;element name="FnlPmtDt" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}ISODate" minOccurs="0"/&gt;
...
public class CreditTransferMandateData1 {
	...
	public String toString() {
		return "CreditTransferMandateData1 {'mndtId':'" + mndtId + "', 'tp':'" + tp + "', 'dtOfSgntr':'" + dtOfSgntr
				+ "', 'dtOfVrfctn':'" + dtOfVrfctn + "', 'elctrncSgntr':'" + Arrays.toString(elctrncSgntr)
				+ "', 'frstPmtDt':'" + frstPmtDt + "', 'fnlPmtDt':'" + fnlPmtDt + "', 'frqcy':'" + frqcy + "', 'rsn':'"
				+ rsn + "'}";
	}
