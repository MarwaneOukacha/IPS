 ...
 *       &lt;choice&gt;
 *         &lt;element name="Cd" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}ExternalMandateSetupReason1Code"/&gt;
 *         &lt;element name="Prtry" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}Max70Text"/&gt;
 *       &lt;/choice&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class MandateSetupReason1Choice {
	...
	public String toString() {
		return "MandateSetupReason1Choice {'cd':'" + cd + "', 'prtry':'" + prtry + "'}";
	}
