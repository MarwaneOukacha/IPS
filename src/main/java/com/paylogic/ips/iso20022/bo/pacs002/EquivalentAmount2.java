 ...
 *         &lt;element name="CcyOfTrf" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}ActiveOrHistoricCurrencyCode"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class EquivalentAmount2 {
	...
	public String toString() {
		return "EquivalentAmount2 {'amt':'" + amt + "', 'ccyOfTrf':'" + ccyOfTrf + "'}";
	}
