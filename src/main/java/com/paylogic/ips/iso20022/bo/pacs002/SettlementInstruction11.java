...
/**
 * <p>Classe Java pour SettlementInstruction11 complex type.
 * 
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="SttlmMtd" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}SettlementMethod1Code"/&gt;
 *         &lt;element name="SttlmAcct" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}CashAccount40" minOccurs="0"/&gt;
 *         &lt;element name="ClrSys" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}ClearingSystemIdentification3Choice" minOccurs="0"/&gt;
 *         &lt;element name="InstgRmbrsmntAgt" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}BranchAndFinancialInstitutionIdentification6" minOccurs="0"/&gt;
 *         &lt;element name="InstgRmbrsmntAgtAcct" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}CashAccount40" minOccurs="0"/&gt;
 *         &lt;element name="InstdRmbrsmntAgt" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}BranchAndFinancialInstitutionIdentification6" minOccurs="0"/&gt;
 *         &lt;element name="InstdRmbrsmntAgtAcct" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}CashAccount40" minOccurs="0"/&gt;
 *         &lt;element name="ThrdRmbrsmntAgt" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}BranchAndFinancialInstitutionIdentification6" minOccurs="0"/&gt;
 *         &lt;element name="ThrdRmbrsmntAgtAcct" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}CashAccount40" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class SettlementInstruction11 {
	...
	public String toString() {
		return "SettlementInstruction11 {'sttlmMtd':'" + sttlmMtd + "', 'sttlmAcct':'" + sttlmAcct + "', 'clrSys':'"
				+ clrSys + "', 'instgRmbrsmntAgt':'" + instgRmbrsmntAgt + "', 'instgRmbrsmntAgtAcct':'"
				+ instgRmbrsmntAgtAcct + "', 'instdRmbrsmntAgt':'" + instdRmbrsmntAgt + "', 'instdRmbrsmntAgtAcct':'"
				+ instdRmbrsmntAgtAcct + "', 'thrdRmbrsmntAgt':'" + thrdRmbrsmntAgt + "', 'thrdRmbrsmntAgtAcct':'"
				+ thrdRmbrsmntAgtAcct + "'}";
	}
