 ...
 *   &lt;simpleContent&gt;
 *     &lt;extension base="&lt;urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13&gt;ActiveOrHistoricCurrencyAndAmount_SimpleType"&gt;
 *       &lt;attribute name="Ccy" use="required" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}ActiveOrHistoricCurrencyCode" /&gt;
 *     &lt;/extension&gt;
 *   &lt;/simpleContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
public class ActiveOrHistoricCurrencyAndAmount {
	...
	public String toString() {
		return "ActiveOrHistoricCurrencyAndAmount {'value':'" + value + "', 'ccy':'" + ccy + "'}";
	}
