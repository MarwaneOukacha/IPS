 ...
 *       &lt;choice&gt;
 *         &lt;element name="OrgId" type="{urn:iso:std:iso:20022:tech:xsd:acmt.023.001.03}OrganisationIdentification29"/&gt;
 *         &lt;element name="PrvtId" type="{urn:iso:std:iso:20022:tech:xsd:acmt.023.001.03}PersonIdentification13"/&gt;
 *       &lt;/choice&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class Party38Choice {
	...
	public String toString() {
		return "Party38Choice {'orgId':'" + orgId + "', 'prvtId':'" + prvtId + "'}";
	}
