...
/**
 * <p>Classe Java pour DiscountAmountType1Choice complex type.
 * 
 ...
 *       &lt;choice&gt;
 *         &lt;element name="Cd" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}ExternalDiscountAmountType1Code"/&gt;
 *         &lt;element name="Prtry" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}Max35Text"/&gt;
 *       &lt;/choice&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class DiscountAmountType1Choice {
	...
	public String toString() {
		return "DiscountAmountType1Choice {'cd':'" + cd + "', 'prtry':'" + prtry + "'}";
	}
