...
/**
 * <p>Classe Java pour MessageIdentification7 complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="MessageIdentification7"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="MsgId" type="{urn:iso:std:iso:20022:tech:xsd:acmt.024.001.03}Max35Text" minOccurs="0"/&gt;
 *         &lt;element name="CreDtTm" type="{urn:iso:std:iso:20022:tech:xsd:acmt.024.001.03}ISODateTime" minOccurs="0"/&gt;
...
@XmlType(name = "MessageIdentification7", propOrder = {
    "msgId",
    "creDtTm",
    "frstAgt"
})
public class MessageIdentification7 {
	...
	public String toString() {
		return "MessageIdentification7 {'msgId':'" + msgId + "', 'creDtTm':'" + creDtTm + "', 'frstAgt':'" + frstAgt
				+ "'}";
	}
