 ...
 *       &lt;sequence&gt;
 *         &lt;element name="InstrPrty" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}Priority2Code" minOccurs="0"/&gt;
 *         &lt;element name="ClrChanl" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}ClearingChannel2Code" minOccurs="0"/&gt;
 *         &lt;element name="SvcLvl" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}ServiceLevel8Choice" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="LclInstrm" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}LocalInstrument2Choice" minOccurs="0"/&gt;
 *         &lt;element name="SeqTp" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}SequenceType3Code" minOccurs="0"/&gt;
 *         &lt;element name="CtgyPurp" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}CategoryPurpose1Choice" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class PaymentTypeInformation27 {
	...
	public String toString() {
		return "PaymentTypeInformation27 {'instrPrty':'" + instrPrty + "', 'clrChanl':'" + clrChanl + "', 'svcLvl':'"
				+ svcLvl + "', 'lclInstrm':'" + lclInstrm + "', 'seqTp':'" + seqTp + "', 'ctgyPurp':'" + ctgyPurp
				+ "'}";
	}
