 ...
 *       &lt;sequence&gt;
 *         &lt;element name="FrDt" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}ISODate"/&gt;
 *         &lt;element name="ToDt" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}ISODate"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class DatePeriod2 {
	...
	public String toString() {
		return "DatePeriod2 {'frDt':'" + frDt + "', 'toDt':'" + toDt + "'}";
	}
