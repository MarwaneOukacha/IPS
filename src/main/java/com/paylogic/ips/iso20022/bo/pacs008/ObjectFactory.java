 ...
 * generated in the com.paylogic.ama.cbe.iso20022.bo.pacs008 package. 
...
public class ObjectFactory {
    ...
    private final static QName _Document_QNAME = new QName("urn:iso:std:iso:20022:tech:xsd:pacs.008.001.11", "Document");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.paylogic.ama.cbe.iso20022.bo.pacs008
     * 
     */
    ...
    /**
     * Create an instance of {@link DocumentPacs008 }
     * 
     */
    public DocumentPacs008 createDocument() {
        return new DocumentPacs008();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link DocumentPacs008 }{@code >}
     * 
     * @param value
     *     Java instance representing xml element's value.
     * @return
     *     the new instance of {@link JAXBElement }{@code <}{@link DocumentPacs008 }{@code >}
     */
    @XmlElementDecl(namespace = "urn:iso:std:iso:20022:tech:xsd:pacs.008.001.11", name = "Document")
    public JAXBElement<DocumentPacs008> createDocument(DocumentPacs008 value) {
        return new JAXBElement<DocumentPacs008>(_Document_QNAME, DocumentPacs008.class, null, value);
    }
