 ...
 *       &lt;sequence&gt;
 *         &lt;element name="DtldNbOfTxs" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}Max15NumericText"/&gt;
 *         &lt;element name="DtldSts" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}ExternalPaymentTransactionStatus1Code"/&gt;
 *         &lt;element name="DtldCtrlSum" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}DecimalNumber" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class NumberOfTransactionsPerStatus5 {
	...
	public String toString() {
		return "NumberOfTransactionsPerStatus5 {'dtldNbOfTxs':'" + dtldNbOfTxs + "', 'dtldSts':'" + dtldSts
				+ "', 'dtldCtrlSum':'" + dtldCtrlSum + "'}";
	}
