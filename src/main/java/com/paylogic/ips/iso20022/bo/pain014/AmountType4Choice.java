 ...
 *       &lt;choice&gt;
 *         &lt;element name="InstdAmt" type="{urn:iso:std:iso:20022:tech:xsd:pain.014.001.10}ActiveOrHistoricCurrencyAndAmount"/&gt;
 *         &lt;element name="EqvtAmt" type="{urn:iso:std:iso:20022:tech:xsd:pain.014.001.10}EquivalentAmount2"/&gt;
 *       &lt;/choice&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class AmountType4Choice {
    ...
    /**
     * Obtient la valeur de la propriété eqvtAmt.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Définit la valeur de la propriété eqvtAmt.
     * 
     * @param value
     *     allowed object is
     *     {@link EquivalentAmount2 }
