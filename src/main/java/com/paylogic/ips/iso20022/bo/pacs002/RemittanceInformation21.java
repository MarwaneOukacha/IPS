 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Ustrd" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}Max140Text" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="Strd" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}StructuredRemittanceInformation17" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class RemittanceInformation21 {
	...
	public String toString() {
		return "RemittanceInformation21 {'ustrd':'" + ustrd + "', 'strd':'" + strd + "'}";
	}
