...
/**
 * <p>Classe Java pour MandateRelatedInformation15 complex type.
 * 
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="MndtId" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}Max35Text" minOccurs="0"/&gt;
 *         &lt;element name="DtOfSgntr" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}ISODate" minOccurs="0"/&gt;
 *         &lt;element name="AmdmntInd" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}TrueFalseIndicator" minOccurs="0"/&gt;
 *         &lt;element name="AmdmntInfDtls" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}AmendmentInformationDetails14" minOccurs="0"/&gt;
 *         &lt;element name="ElctrncSgntr" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}Max1025Text" minOccurs="0"/&gt;
 *         &lt;element name="FrstColltnDt" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}ISODate" minOccurs="0"/&gt;
 *         &lt;element name="FnlColltnDt" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}ISODate" minOccurs="0"/&gt;
 *         &lt;element name="Frqcy" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}Frequency36Choice" minOccurs="0"/&gt;
 *         &lt;element name="Rsn" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}MandateSetupReason1Choice" minOccurs="0"/&gt;
 *         &lt;element name="TrckgDays" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}Exact2NumericText" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class MandateRelatedInformation15 {
	...
	public String toString() {
		return "MandateRelatedInformation15 {'mndtId':'" + mndtId + "', 'dtOfSgntr':'" + dtOfSgntr + "', 'amdmntInd':'"
				+ amdmntInd + "', 'amdmntInfDtls':'" + amdmntInfDtls + "', 'elctrncSgntr':'" + elctrncSgntr
				+ "', 'frstColltnDt':'" + frstColltnDt + "', 'fnlColltnDt':'" + fnlColltnDt + "', 'frqcy':'" + frqcy
				+ "', 'rsn':'" + rsn + "', 'trckgDays':'" + trckgDays + "'}";
	}
