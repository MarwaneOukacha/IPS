 ...
 *       &lt;choice&gt;
 *         &lt;element name="Cd" type="{urn:iso:std:iso:20022:tech:xsd:acmt.023.001.03}ExternalFinancialInstitutionIdentification1Code"/&gt;
 *         &lt;element name="Prtry" type="{urn:iso:std:iso:20022:tech:xsd:acmt.023.001.03}Max35Text"/&gt;
 *       &lt;/choice&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class FinancialIdentificationSchemeName1Choice {
	...
	public String toString() {
		return "FinancialIdentificationSchemeName1Choice {'cd':'" + cd + "', 'prtry':'" + prtry + "'}";
	}
