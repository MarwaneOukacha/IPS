 ...
 *       &lt;choice&gt;
 *         &lt;element name="Cd" type="{urn:iso:std:iso:20022:tech:xsd:acmt.023.001.03}AddressType2Code"/&gt;
 *         &lt;element name="Prtry" type="{urn:iso:std:iso:20022:tech:xsd:acmt.023.001.03}GenericIdentification30"/&gt;
 *       &lt;/choice&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class AddressType3Choice {
	...
	public String toString() {
		return "AddressType3Choice {'cd':'" + cd + "', 'prtry':'" + prtry + "'}";
	}
