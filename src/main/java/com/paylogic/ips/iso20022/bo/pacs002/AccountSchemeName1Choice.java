 ...
 *       &lt;choice&gt;
 *         &lt;element name="Cd" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}ExternalAccountIdentification1Code"/&gt;
...
public class AccountSchemeName1Choice {
	...
	public String toString() {
		return "AccountSchemeName1Choice {'cd':'" + cd + "', 'prtry':'" + prtry + "'}";
	}
