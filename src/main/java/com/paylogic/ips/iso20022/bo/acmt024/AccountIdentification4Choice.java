 ...
 *       &lt;choice&gt;
 *         &lt;element name="IBAN" type="{urn:iso:std:iso:20022:tech:xsd:acmt.024.001.03}IBAN2007Identifier"/&gt;
 *         &lt;element name="Othr" type="{urn:iso:std:iso:20022:tech:xsd:acmt.024.001.03}GenericAccountIdentification1"/&gt;
 *       &lt;/choice&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class AccountIdentification4Choice {
	...
	public String toString() {
		return "AccountIdentification4Choice {'iban':'" + iban + "', 'othr':'" + othr + "'}";
	}
