 ...
 *       &lt;sequence&gt;
 *         &lt;element name="BICFI" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}BICFIDec2014Identifier" minOccurs="0"/&gt;
 *         &lt;element name="ClrSysMmbId" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}ClearingSystemMemberIdentification2" minOccurs="0"/&gt;
 *         &lt;element name="LEI" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}LEIIdentifier" minOccurs="0"/&gt;
 *         &lt;element name="Nm" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}Max140Text" minOccurs="0"/&gt;
 *         &lt;element name="PstlAdr" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}PostalAddress24" minOccurs="0"/&gt;
 *         &lt;element name="Othr" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}GenericFinancialIdentification1" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class FinancialInstitutionIdentification18 {
	...
	public String toString() {
		return "FinancialInstitutionIdentification18 {'bicfi':'" + bicfi + "', 'clrSysMmbId':'" + clrSysMmbId
				+ "', 'lei':'" + lei + "', 'nm':'" + nm + "', 'pstlAdr':'" + pstlAdr + "', 'othr':'" + othr + "'}";
	}
