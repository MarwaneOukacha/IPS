 ...
 *       &lt;sequence&gt;
 *         &lt;element name="BirthDt" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}ISODate"/&gt;
 *         &lt;element name="PrvcOfBirth" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}Max35Text" minOccurs="0"/&gt;
 *         &lt;element name="CityOfBirth" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}Max35Text"/&gt;
 *         &lt;element name="CtryOfBirth" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}CountryCode"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class DateAndPlaceOfBirth1 {
	...
	public String toString() {
		return "DateAndPlaceOfBirth1 {'birthDt':'" + birthDt + "', 'prvcOfBirth':'" + prvcOfBirth + "', 'cityOfBirth':'"
