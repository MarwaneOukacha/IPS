 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Tp" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}ReferredDocumentType4" minOccurs="0"/&gt;
 *         &lt;element name="Nb" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}Max35Text" minOccurs="0"/&gt;
 *         &lt;element name="RltdDt" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}ISODate" minOccurs="0"/&gt;
 *         &lt;element name="LineDtls" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}DocumentLineInformation1" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class ReferredDocumentInformation7 {
	...
	public String toString() {
		return "ReferredDocumentInformation7 {'tp':'" + tp + "', 'nb':'" + nb + "', 'rltdDt':'" + rltdDt
				+ "', 'lineDtls':'" + lineDtls + "'}";
	}
