 ...
 *         &lt;element name="CdtDbtInd" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}CreditDebitCode" minOccurs="0"/&gt;
 *         &lt;element name="Rsn" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}Max4Text" minOccurs="0"/&gt;
...
public class DocumentAdjustment1 {
	...
	public String toString() {
		return "DocumentAdjustment1 {'amt':'" + amt + "', 'cdtDbtInd':'" + cdtDbtInd + "', 'rsn':'" + rsn
				+ "', 'addtlInf':'" + addtlInf + "'}";
	}
