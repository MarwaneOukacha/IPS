 ...
 *       &lt;choice&gt;
 *         &lt;element name="Cd" type="{urn:iso:std:iso:20022:tech:xsd:acmt.024.001.03}ExternalClearingSystemIdentification1Code"/&gt;
...
public class ClearingSystemIdentification2Choice {
	...
	public String toString() {
		return "ClearingSystemIdentification2Choice {'cd':'" + cd + "', 'prtry':'" + prtry + "'}";
	}
