 ...
 *       &lt;choice&gt;
 *         &lt;element name="Tp" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}Frequency6Code"/&gt;
 *         &lt;element name="Prd" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}FrequencyPeriod1"/&gt;
 *         &lt;element name="PtInTm" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}FrequencyAndMoment1"/&gt;
 *       &lt;/choice&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class Frequency36Choice {
	...
	public String toString() {
		return "Frequency36Choice {'tp':'" + tp + "', 'prd':'" + prd + "', 'ptInTm':'" + ptInTm + "'}";
	}
