 ...
 *       &lt;sequence&gt;
 *         &lt;element name="CdOrPrtry" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}CreditorReferenceType1Choice"/&gt;
...
public class CreditorReferenceType2 {
	...
	public String toString() {
		return "CreditorReferenceType2 {'cdOrPrtry':'" + cdOrPrtry + "', 'issr':'" + issr + "'}";
	}
