 ...
 *       &lt;sequence&gt;
 *         &lt;element name="CdOrPrtry" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}GarnishmentType1Choice"/&gt;
...
public class GarnishmentType1 {
	...
	public String toString() {
		return "GarnishmentType1 {'cdOrPrtry':'" + cdOrPrtry + "', 'issr':'" + issr + "'}";
	}
