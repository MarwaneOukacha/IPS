 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Id" type="{urn:iso:std:iso:20022:tech:xsd:acmt.024.001.03}AccountIdentification4Choice" minOccurs="0"/&gt;
 *         &lt;element name="Tp" type="{urn:iso:std:iso:20022:tech:xsd:acmt.024.001.03}CashAccountType2Choice" minOccurs="0"/&gt;
 *         &lt;element name="Ccy" type="{urn:iso:std:iso:20022:tech:xsd:acmt.024.001.03}ActiveOrHistoricCurrencyCode" minOccurs="0"/&gt;
 *         &lt;element name="Nm" type="{urn:iso:std:iso:20022:tech:xsd:acmt.024.001.03}Max70Text" minOccurs="0"/&gt;
 *         &lt;element name="Prxy" type="{urn:iso:std:iso:20022:tech:xsd:acmt.024.001.03}ProxyAccountIdentification1" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class CashAccount40 {
	...
	public String toString() {
		return "CashAccount40 {'id':'" + id + "', 'tp':'" + tp + "', 'ccy':'" + ccy + "', 'nm':'" + nm + "', 'prxy':'"
				+ prxy + "'}";
	}
