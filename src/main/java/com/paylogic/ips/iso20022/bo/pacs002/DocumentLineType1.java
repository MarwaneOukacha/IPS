 ...
 *       &lt;sequence&gt;
 *         &lt;element name="CdOrPrtry" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}DocumentLineType1Choice"/&gt;
...
public class DocumentLineType1 {
	...
	public String toString() {
		return "DocumentLineType1 {'cdOrPrtry':'" + cdOrPrtry + "', 'issr':'" + issr + "'}";
	}
