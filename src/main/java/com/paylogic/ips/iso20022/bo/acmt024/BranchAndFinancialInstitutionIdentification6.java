 ...
 *       &lt;sequence&gt;
 *         &lt;element name="FinInstnId" type="{urn:iso:std:iso:20022:tech:xsd:acmt.024.001.03}FinancialInstitutionIdentification18"/&gt;
 *         &lt;element name="BrnchId" type="{urn:iso:std:iso:20022:tech:xsd:acmt.024.001.03}BranchData3" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class BranchAndFinancialInstitutionIdentification6 {
	...
	public String toString() {
		return "BranchAndFinancialInstitutionIdentification6 {'finInstnId':'" + finInstnId + "', 'brnchId':'" + brnchId
				+ "'}";
	}
