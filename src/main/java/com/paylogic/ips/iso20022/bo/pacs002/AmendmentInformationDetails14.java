 ...
 *       &lt;sequence&gt;
 *         &lt;element name="OrgnlMndtId" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}Max35Text" minOccurs="0"/&gt;
 *         &lt;element name="OrgnlCdtrSchmeId" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}PartyIdentification135" minOccurs="0"/&gt;
 *         &lt;element name="OrgnlCdtrAgt" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}BranchAndFinancialInstitutionIdentification6" minOccurs="0"/&gt;
 *         &lt;element name="OrgnlCdtrAgtAcct" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}CashAccount40" minOccurs="0"/&gt;
 *         &lt;element name="OrgnlDbtr" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}PartyIdentification135" minOccurs="0"/&gt;
 *         &lt;element name="OrgnlDbtrAcct" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}CashAccount40" minOccurs="0"/&gt;
 *         &lt;element name="OrgnlDbtrAgt" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}BranchAndFinancialInstitutionIdentification6" minOccurs="0"/&gt;
 *         &lt;element name="OrgnlDbtrAgtAcct" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}CashAccount40" minOccurs="0"/&gt;
 *         &lt;element name="OrgnlFnlColltnDt" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}ISODate" minOccurs="0"/&gt;
 *         &lt;element name="OrgnlFrqcy" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}Frequency36Choice" minOccurs="0"/&gt;
 *         &lt;element name="OrgnlRsn" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}MandateSetupReason1Choice" minOccurs="0"/&gt;
 *         &lt;element name="OrgnlTrckgDays" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13}Exact2NumericText" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class AmendmentInformationDetails14 {
	...
	public String toString() {
		return "AmendmentInformationDetails14 {'orgnlMndtId':'" + orgnlMndtId + "', 'orgnlCdtrSchmeId':'"
				+ orgnlCdtrSchmeId + "', 'orgnlCdtrAgt':'" + orgnlCdtrAgt + "', 'orgnlCdtrAgtAcct':'" + orgnlCdtrAgtAcct
				+ "', 'orgnlDbtr':'" + orgnlDbtr + "', 'orgnlDbtrAcct':'" + orgnlDbtrAcct + "', 'orgnlDbtrAgt':'"
				+ orgnlDbtrAgt + "', 'orgnlDbtrAgtAcct':'" + orgnlDbtrAgtAcct + "', 'orgnlFnlColltnDt':'"
				+ orgnlFnlColltnDt + "', 'orgnlFrqcy':'" + orgnlFrqcy + "', 'orgnlRsn':'" + orgnlRsn
				+ "', 'orgnlTrckgDays':'" + orgnlTrckgDays + "'}";
	}
