...
public class CasCustomeraRegisterBo {
	private UidBo uid;
	...
	public MemberEndPoint getMemberEndPoint() {
		return memberEndPoint;
	}

	public void setMemberEndPoint(MemberEndPoint memberEndPoint) {
		this.memberEndPoint = memberEndPoint;
	}

	@Override
	public String toString() {
		return "CasCustomeraRegisterBo [uid=" + uid + ", documentType=" + documentType + ", documentNumber="
				...
				+ ", address=" + address + ", aliases=" + aliases + ", memberEndPoint=" + memberEndPoint + "]";
	}
